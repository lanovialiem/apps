<div class="container">
    <div class="page-header">
        {{-- <img src="{{ url('https://www.solidbackgrounds.com/images/website/950x534/950x534-blue-abstract-noise-free-website-background-image.jpg') }}" alt="Logo" class="h-full w-auto object-contain"> --}}
    </div>
    <div class="employee-card">
        ...
        <body
            class="bg-gradient-to-br from-orange-500 via-red-500 to-red-600 min-h-screen flex items-center justify-center p-4">

            <div
                class="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden relative z-10 border-t-4 border-orange-500">
                ...
                <div class="bg-gradient-to-r from-orange-500 to-red-500 p-8 text-center relative overflow-hidden">
                    ...
                    <div class="absolute top-0 right-0 -mt-8 -mr-8 w-32 h-32 bg-white opacity-10 rounded-full blur-2xl">
                    </div>
                    <div
                        class="absolute bottom-0 left-0 -mb-8 -ml-8 w-24 h-24 bg-yellow-300 opacity-20 rounded-full blur-xl">
                    </div>

                    <div class="relative z-10">
                        <!-- Logo -->
                        <div class="mb-4 flex justify-center">
                            <img src="{{ asset('img-home/logo_nmp.png') }}" alt="Logo"
                ...
                <div class="p-8">
                    ...
                    @if ($errors->any())
                        <div
                            class="mb-4 p-3 bg-red-50 border-l-4 border-red-500 text-red-600 text-sm rounded-r flex items-center">
                    ...
                    <form id="authForm" method="POST" action="{{ route('loginProses') }}" class="space-y-5">
                        ...
                        <div id="nameField" class="hidden group">
                            ...
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400 group-focus-within:text-orange-500 transition"
                        ...
                        <!-- Email Field -->
                        <div class="group">
                            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Email
                                Address</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400 group-focus-within:text-orange-500 transition"
                        ...
                        <div class="group">
                            <label
                                class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Password</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400 group-focus-within:text-orange-500 transition"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div id="confirmField" class="hidden group">
                            <label
                                class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Confirm
                                Password</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400 group-focus-within:text-orange-500 transition"
                        ...
                        <button type="submit" id="submit"
                            ...
                            <span
                                class="absolute inset-0 w-full h-full bg-white opacity-0 group-hover:opacity-10 transition-opacity rounded-lg"></span>
                            Login
                        </button>
                    </form>
                    ...
                    <div class="mt-8 text-center border-t border-gray-100 pt-6">
                        <p class="text-sm text-gray-600">
                            ...
                            <button type="button" onclick="toggleForm()"
                                class="text-orange-600 font-bold hover:text-orange-800 ml-1 transition">
                                Register/Login
                            </button>
                        </p>
                    </div>
