            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <select name="penawaran_id" id="penawaran_id"
                        ...
                        <option value="{{ $penawaran->id }}" {{ old('penawaran_id')==$penawaran->id ? 'selected' : ''
                            }}>

                            {{ $penawaran->offer_number }}
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <label
                            ...
                            <input type="radio" name="status" value="pending"
                                class="text-yellow-500 focus:ring-yellow-400" {{ old('status', 'pending' )=='pending'
                                ? 'checked' : '' }}>
                        ...
                        <label
                            ...
                            <input type="radio" name="status" value="approved"
                                class="text-green-500 focus:ring-green-400" {{ old('status')=='approved' ? 'checked'
                                : '' }}>
                        ...
                        <label
                            ...
                            <input type="radio" name="status" value="rejected" class="text-red-500 focus:ring-red-400"
